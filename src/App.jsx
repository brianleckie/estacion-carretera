...
const EMPRENDEDORES_DATA = {
  "Almaluna":           { tel: "994855562", duena: "Marlene Kleiner",  origen: "Emprendimiento local" },
  "Gloria Estampados":  { tel: "994855562", duena: "Gloria",           origen: "Emprendimiento local" },
  "Arte Paraguayo":     { tel: "994855562", duena: "Ana Villalba",     origen: "Emprendimiento local" },
  "Campo Verde":        { tel: "994855562", duena: "Luis Reimer",      origen: "Emprendimiento local" },
  "Lácteos Hohenau":    { tel: "994855562", duena: "Familia Schmidt",  origen: "Emprendimiento local" },
  "Tejidos del Sur":    { tel: "994855562", duena: "Rosa Flores",      origen: "Emprendimiento local" },
  "Cerámica Nativa":    { tel: "994855562", duena: "Elena Torres",     origen: "Emprendimiento local" },
  "Sabores de Itapúa":  { tel: "994855562", duena: "Familia Müller",   origen: "Emprendimiento local" },
};
...
const PRODUCTS = [
  { id: 1,  name: "Jabón Artesanal Natural",      price: 28000,  category: "Cosmética",   vendedora: "Almaluna",
    image: "https://images.unsplash.com/photo-1600857544200-b2f666a9a2ec?w=600&h=600&fit=crop",
    badge: "Destacado", desc: "Jabones artesanales elaborados con ingredientes naturales de la región. Sin sulfatos ni parabenos. Cada pieza hecha a mano por Marlene Kleiner bajo su emprendimiento Almaluna." },
  { id: 2,  name: "Remera Estampada Guaraní",     price: 85000,  category: "Ropa",        vendedora: "Gloria Estampados",
    image: "https://images.unsplash.com/photo-1583743814966-8936f5b7be1a?w=600&h=600&fit=crop",
    badge: "Nuevo", desc: "Remeras de algodón con diseños originales inspirados en la cultura guaraní y la flora paraguaya. Estampado artesanal hecho a mano por Gloria." },
  { id: 3,  name: "Pintura Paisaje Paraguayo",    price: 320000, category: "Arte",        vendedora: "Arte Paraguayo",
    image: "https://images.unsplash.com/photo-1579783902614-a3fb3927b6a5?w=600&h=600&fit=crop",
    badge: null, desc: "Pinturas al óleo sobre tela, representando paisajes naturales del departamento de Itapúa. Piezas únicas firmadas por la artista." },
  { id: 4,  name: "Miel de Abeja Pura",           price: 45000,  category: "Alimentos",  vendedora: "Campo Verde",
  ...
  { id: 5,  name: "Queso Paraguay Fresco",        price: 38000,  category: "Alimentos",  vendedora: "Lácteos Hohenau",
    image: "https://images.unsplash.com/photo-1552767059-ce182ead6c1b?w=600&h=600&fit=crop",
    badge: null, desc: "Queso fresco elaborado con leche de vaca de pastoreo libre. Receta tradicional de la colonia alemana de Hohenau, sin conservantes." },
  { id: 6,  name: "Hamaca Paraguaya Tejida",      price: 180000, category: "Textiles",   vendedora: "Tejidos del Sur",
    image: "https://images.unsplash.com/photo-1499793983690-e29da59ef1c2?w=600&h=600&fit=crop",
    badge: "Artesanal", desc: "Hamaca tradicional paraguaya tejida a mano en telar. Resistente, colorida y duradera. Ideal para uso exterior e interior." },
  { id: 7,  name: "Jarra Decorada a Mano",        price: 65000,  category: "Cerámica",   vendedora: "Cerámica Nativa",
    image: "https://images.unsplash.com/photo-1565193566173-7a0ee3dbe261?w=600&h=600&fit=crop",
    badge: null, desc: "Jarra de cerámica pintada a mano con motivos naturales y geométricos. Piezas únicas cocidas en horno artesanal." },
  { id: 8,  name: "Mermelada de Guayaba",         price: 22000,  category: "Alimentos",  vendedora: "Sabores de Itapúa",
    image: "https://images.unsplash.com/photo-1563805042-7684c019e1cb?w=600&h=600&fit=crop",
    badge: "Oferta", desc: "Mermeladas de frutas de temporada: guayaba, mamón y mburucuyá. Sin conservantes, elaboradas en pequeños lotes con frutas de la zona." },
  { id: 9,  name: "Utensilios de Madera Nativa",  price: 55000,  category: "Madera",     vendedora: "Campo Verde",
    image: "https://images.unsplash.com/photo-1590794056226-79ef3a8147e1?w=600&h=600&fit=crop",
    badge: null, desc: "Set de utensilios de cocina tallados en madera nativa. Tratados con aceite natural, libres de barnices tóxicos. Resistentes al uso diario." },
  { id: 10, name: "Canasto Tejido Artesanal",     price: 72000,  category: "Textiles",   vendedora: "Tejidos del Sur",
    image: "https://images.unsplash.com/photo-1606722590583-6951b5ea92ad?w=600&h=600&fit=crop",
    badge: null, desc: "Canasto tejido con fibras naturales de la región usando técnicas transmitidas por generaciones. Cada pieza es completamente única." },
];

const CATEGORIES = ["Todos", "Alimentos", "Artesanías", "Textiles", "Cerámica", "Ropa", "Arte", "Cosmética", "Madera"];
...
const EMPRENDEDORES = [
  ...
  { name: "Campo Verde",       duena: "Luis Reimer",      rubro: "Miel y productos campo",   products: 9,  avatar: "CV" },
  { name: "Lácteos Hohenau",   duena: "Familia Schmidt",  rubro: "Quesos y lácteos",         products: 7,  avatar: "LH" },
  { name: "Tejidos del Sur",   duena: "Rosa Flores",      rubro: "Hamacas y tejidos",        products: 11, avatar: "TS" },
  { name: "Cerámica Nativa",   duena: "Elena Torres",     rubro: "Cerámica y jarras",        products: 8,  avatar: "CN" },
  { name: "Sabores de Itapúa", duena: "Familia Müller",   rubro: "Mermeladas y dulces",      products: 6,  avatar: "SI" },
];
    ...
    <>
      <style>{`
        ...
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;}
        ...
        /* MODAL */
        .modal-overlay{position:fixed;inset:0;background:rgba(44,36,22,0.6);z-index:300;
        ...
        .modal{background:var(--white);border-radius:20px;overflow:hidden;width:100%;
          ...
          grid-template-columns:1fr 1fr;transform:scale(.95);transition:transform .3s;}
        .modal-overlay.open .modal{transform:scale(1);}
        .modal-img-wrap{position:relative;aspect-ratio:1;}
        .modal-img{width:100%;height:100%;object-fit:cover;display:block;}
        .modal-badge{position:absolute;top:14px;left:14px;background:var(--green);color:white;
          font-size:10px;font-weight:700;letter-spacing:.06em;text-transform:uppercase;
          padding:5px 12px;border-radius:10px;}
        .modal-body{padding:36px 32px;display:flex;flex-direction:column;justify-content:center;gap:14px;}
        .modal-vendor{font-size:11px;font-weight:700;color:var(--green);letter-spacing:.1em;text-transform:uppercase;}
        ...
        .emp-section .section-sub{color:rgba(255,255,255,0.6);}
        .emp-grid{display:grid;grid-template-columns:repeat(auto-fill,minmax(200px,1fr));gap:16px;margin-top:40px;}
        .emp-card{background:rgba(255,255,255,0.07);border:1px solid rgba(255,255,255,0.1);
          border-radius:14px;padding:22px 18px;text-align:center;transition:background .2s;}
        .emp-card:hover{background:rgba(255,255,255,0.12);}
        ...
        .emp-name{font-family:'Playfair Display',serif;font-size:15px;font-weight:600;color:white;margin-bottom:4px;}
        ...
        /* CONTACTO */
        .contacto-section{padding:60px;background:var(--white);border-top:1px solid var(--cream-dark);}
        .contacto-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:24px;margin-top:40px;}
        .contacto-card{display:flex;flex-direction:column;align-items:center;text-align:center;
          padding:28px 20px;background:var(--cream);border-radius:16px;gap:12px;transition:transform .2s;}
        .contacto-card:hover{transform:translateY(-3px);}
        .contacto-icon{font-size:30px;}
        .contacto-label{font-size:11px;font-weight:700;letter-spacing:.1em;text-transform:uppercase;color:var(--warm);}
        .contacto-val{font-family:'Playfair Display',serif;font-size:17px;font-weight:600;color:var(--brown);}
        .contacto-link{text-decoration:none;color:inherit;display:contents;}
        .contacto-btn{background:var(--green);color:white;border:none;padding:10px 20px;
        ...
        .contacto-btn:hover{background:var(--green-dark);}
      ...
      <section className="hero">
        <div className="hero-left">
          ...
          <p className="hero-sub">
            Más de 50 emprendimientos locales — paraguayos, japoneses, alemanes y brasileños —
      ...
      <section className="section" id="showroom">
        <div className="section-header">
          ...
          <p className="section-sub">Hacé clic en cualquier producto para ver más detalles y contactar al emprendedor</p>
        </div>
        <div className="cats">
          {CATEGORIES.map(c => (
      ...
      <section className="info-section" id="info">
        ...
        <div className="info-grid">
          {[
            ["🏪","Showroom de Emprendedores","Artesanías y productos agropecuarios de 50+ emprendimientos locales, disponibles en tienda física y ahora también online."],
            ["🍜","Food Park de las Naciones","Gastronomía que refleja las culturas japonesa, alemana, brasileña, argentina y paraguaya presentes en la región."],
      ...
      <section className="contacto-section" id="contacto">
        <div className="section-header">
          ...
          <p className="section-sub">Estamos sobre la Ruta PY 06, Hohenau, Itapúa · Abiertos los 7 días</p>
        </div>
